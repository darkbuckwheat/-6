...
public class FilterGreaterThanSpeakingCommand extends AbstractCommand{
    private final CollectionManager collectionManager;
    private final CommandManager commandManager;

    public FilterGreaterThanSpeakingCommand(CollectionManager collectionManager, CommandManager commandManager){
    ...
    public ServerResponse execute(String argument, Object object) throws NumberOfArgumentException, InvalidCommandArguments {
